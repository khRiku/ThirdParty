  ...
  internal class DOTweenUtilityWindow : EditorWindow
  {
    ...
    private bool Init()
    {
      ...
      if ((UnityEngine.Object) this._headerImg == (UnityEngine.Object) null)
      {
        ...
        if ((UnityEngine.Object) this._headerImg == (UnityEngine.Object) null)
          return false;
        EditorUtils.SetEditorTexture(this._headerImg, UnityEngine.FilterMode.Bilinear, 512);
        ...
        EditorUtils.SetEditorTexture(this._footerImg, UnityEngine.FilterMode.Bilinear, 256);
