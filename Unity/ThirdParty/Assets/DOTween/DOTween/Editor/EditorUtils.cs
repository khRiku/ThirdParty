...
namespace DG.DOTweenEditor
{
  public static class EditorUtils
  {
    ...
    /// </summary>
    public static void SetEditorTexture(Texture2D texture, UnityEngine.FilterMode filterMode = UnityEngine.FilterMode.Point, int maxTextureSize = 32)
    {
      ...
      atPath.npotScale = TextureImporterNPOTScale.None;
    ...
    public static void DeleteDOTweenUpgradeManagerFiles()
    {
      ...
      EditorUtils.DeleteAssetsIfExist(new string[3]
      {
    ...
    private static void DeleteAssetsIfExist(string[] adbFilePaths)
    {
      foreach (string adbFilePath in adbFilePaths)
      {
        if (EditorUtils.AssetExists(adbFilePath))
          AssetDatabase.DeleteAsset(adbFilePath);
      }
    }
    ...
    private static void StoreDOTweenDirs()
    {
      ...
      string str = EditorUtils._dotweenDir.IndexOf("/") != -1 ? "/" : "\\";
