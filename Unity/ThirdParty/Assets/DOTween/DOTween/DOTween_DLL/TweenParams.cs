...
namespace DG.Tweening
{
  ...
  public class TweenParams
  {
    ...
    {
      this.id = this.target = (object) null;
      this.updateType = DOTween.defaultUpdateType;
      this.isIndependentUpdate = DOTween.defaultTimeScaleIndependent;
      this.onStart = this.onPlay = this.onRewind = this.onUpdate = this.onStepComplete = this.onComplete = this.onKill = (TweenCallback) null;
