...
namespace DG.Tweening
{
  ...
  public class DOTween
  {
    ...
    public static RewindCallbackMode rewindCallbackMode = RewindCallbackMode.FireIfPositionChanged;
    ...
    private static IDOTweenInit Init(DOTweenSettings settings, bool? recycleAllByDefault, bool? useSafeMode, LogBehaviour? logBehaviour)
    {
      ...
      if (Debugger.logPriority >= 2)
        Debugger.Log((object) ("DOTween initialization (useSafeMode: " + DOTween.useSafeMode.ToString() + ", recycling: " + (DOTween.defaultRecyclable ? (object) "ON" : (object) "OFF") + ", logBehaviour: " + (object) DOTween.logBehaviour + ")"));
      return (IDOTweenInit) DOTween.instance;
    }
    ...
    public static void Clear(bool destroy = false)
    {
      ...
      DOTween.defaultEasePeriod = 0.0f;
    ...
    /// <summary>Clears all cached tween pools.</summary>
    ...
    {
      return DOTween.ApplyTo<double, double, NoOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<double, double, NoOptions>) null);
    }
    ...
    {
      return (Tweener) DOTween.ApplyTo<int, int, NoOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<int, int, NoOptions>) null);
    }
    ...
    {
      return (Tweener) DOTween.ApplyTo<uint, uint, UintOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<uint, uint, UintOptions>) null);
    }
    ...
    {
      return (Tweener) DOTween.ApplyTo<long, long, NoOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<long, long, NoOptions>) null);
    }
    ...
    {
      return (Tweener) DOTween.ApplyTo<ulong, ulong, NoOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<ulong, ulong, NoOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<string, string, StringOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<string, string, StringOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<Vector2, Vector2, VectorOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Vector2, Vector2, VectorOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<Vector3, Vector3, VectorOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Vector3, Vector3, VectorOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<Vector4, Vector4, VectorOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Vector4, Vector4, VectorOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<Quaternion, Vector3, QuaternionOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Quaternion, Vector3, QuaternionOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<Color, Color, ColorOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Color, Color, ColorOptions>) null);
    }
    ...
    {
      return DOTween.ApplyTo<Rect, Rect, RectOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Rect, Rect, RectOptions>) null);
    }
    ...
    {
      return (Tweener) DOTween.ApplyTo<RectOffset, RectOffset, NoOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<RectOffset, RectOffset, NoOptions>) null);
    }
    ...
    {
      TweenerCore<Vector3, Vector3, VectorOptions> tweenerCore = DOTween.ApplyTo<Vector3, Vector3, VectorOptions>(getter, setter, new Vector3(endValue, endValue, endValue), duration, (ABSTweenPlugin<Vector3, Vector3, VectorOptions>) null);
    ...
    {
      return DOTween.ApplyTo<Color, Color, ColorOptions>(getter, setter, new Color(0.0f, 0.0f, 0.0f, endValue), duration, (ABSTweenPlugin<Color, Color, ColorOptions>) null).SetOptions(true);
    }
    ...
    /// <param name="endValue">The end value to reach</param>
    /// <param name="duration">The duration of the virtual tween</param>
    public static Tweener To(DOSetter<float> setter, float startValue, float endValue, float duration)
    {
      return (Tweener) DOTween.To((DOGetter<float>) (() => startValue), (DOSetter<float>) (x =>
      {
        startValue = x;
        setter(startValue);
    ...
    public static TweenerCore<Vector3, Vector3[], Vector3ArrayOptions> Punch(DOGetter<Vector3> getter, DOSetter<Vector3> setter, Vector3 direction, float duration, int vibrato = 10, float elasticity = 1f)
    {
      ...
      int length = (int) ((double) vibrato * (double) duration);
      if (length < 2)
        length = 2;
      float num1 = magnitude / (float) length;
      float[] durations = new float[length];
      float num2 = 0.0f;
      for (int index = 0; index < length; ++index)
      {
        float num3 = (float) (index + 1) / (float) length;
        float num4 = duration * num3;
        num2 += num4;
        durations[index] = num4;
      }
      float num5 = duration / num2;
      for (int index = 0; index < length; ++index)
        durations[index] = durations[index] * num5;
      Vector3[] endValues = new Vector3[length];
      for (int index = 0; index < length; ++index)
      {
        if (index < length - 1)
        {
          endValues[index] = index != 0 ? (index % 2 == 0 ? Vector3.ClampMagnitude(direction, magnitude) : -Vector3.ClampMagnitude(direction, magnitude * elasticity)) : direction;
          magnitude -= num1;
        }
        else
          endValues[index] = Vector3.zero;
      }
      return DOTween.ToArray(getter, setter, endValues, durations).NoFrom<Vector3, Vector3[], Vector3ArrayOptions>().SetSpecialStartupMode<TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>>(SpecialStartupMode.SetPunch);
    }
    ...
    {
      float num1 = vectorBased ? strength.magnitude : strength.x;
      int length = (int) ((double) vibrato * (double) duration);
      if (length < 2)
        length = 2;
      float num2 = num1 / (float) length;
      float[] durations = new float[length];
      float num3 = 0.0f;
      for (int index = 0; index < length; ++index)
      {
        float num4 = (float) (index + 1) / (float) length;
        float num5 = fadeOut ? duration * num4 : duration / (float) length;
        num3 += num5;
        durations[index] = num5;
      }
      float num6 = duration / num3;
      for (int index = 0; index < length; ++index)
        durations[index] = durations[index] * num6;
      ...
      for (int index = 0; index < length; ++index)
      {
        ...
        {
          if (index > 0)
            degrees = degrees - 180f + Random.Range(-randomness, randomness);
          if (vectorBased)
          {
            Vector3 vector = Quaternion.AngleAxis(Random.Range(-randomness, randomness), Vector3.up) * Utils.Vector3FromAngle(degrees, num1);
            ...
            endValues[index] = vector;
            if (fadeOut)
              num1 -= num2;
            strength = Vector3.ClampMagnitude(strength, num1);
          }
          else
          {
            if (ignoreZAxis)
            {
              endValues[index] = Utils.Vector3FromAngle(degrees, num1);
            }
            else
            {
              Quaternion quaternion = Quaternion.AngleAxis(Random.Range(-randomness, randomness), Vector3.up);
              endValues[index] = quaternion * Utils.Vector3FromAngle(degrees, num1);
            }
            if (fadeOut)
              num1 -= num2;
          }
      ...
      return DOTween.ToArray(getter, setter, endValues, durations).NoFrom<Vector3, Vector3[], Vector3ArrayOptions>().SetSpecialStartupMode<TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>>(SpecialStartupMode.SetShake);
    }
    ...
    public static TweenerCore<Vector3, Vector3[], Vector3ArrayOptions> ToArray(DOGetter<Vector3> getter, DOSetter<Vector3> setter, Vector3[] endValues, float[] durations)
    {
      ...
      {
        Debugger.LogError((object) "To Vector3 array tween: endValues and durations arrays must have the same length");
        return (TweenerCore<Vector3, Vector3[], Vector3ArrayOptions>) null;
      }
      Vector3[] endValue = new Vector3[length];
      float[] numArray = new float[length];
      for (int index = 0; index < length; ++index)
      {
        endValue[index] = endValues[index];
        numArray[index] = durations[index];
      }
      float duration = 0.0f;
      for (int index = 0; index < length; ++index)
        duration += numArray[index];
      TweenerCore<Vector3, Vector3[], Vector3ArrayOptions> tweenerCore = DOTween.ApplyTo<Vector3, Vector3[], Vector3ArrayOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Vector3, Vector3[], Vector3ArrayOptions>) null).NoFrom<Vector3, Vector3[], Vector3ArrayOptions>();
      tweenerCore.plugOptions.durations = numArray;
      return tweenerCore;
    }
    ...
    {
      return DOTween.ApplyTo<Color2, Color2, ColorOptions>(getter, setter, endValue, duration, (ABSTweenPlugin<Color2, Color2, ColorOptions>) null);
    }
    ...
    /// <param name="withCallbacks">For Sequences only: if TRUE also public Sequence callbacks will be fired,
    /// otherwise they will be ignored</param>
    public static int CompleteAll(bool withCallbacks = false)
    {
      return TweenManager.FilteredOperation(OperationType.Complete, FilterType.All, (object) null, false, withCallbacks ? 1f : 0.0f, (object) null, (object[]) null);
    }
    ...
    /// <param name="withCallbacks">For Sequences only: if TRUE public Sequence callbacks will be fired,
    /// otherwise they will be ignored</param>
    public static int Complete(object targetOrId, bool withCallbacks = false)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Complete, FilterType.TargetOrId, targetOrId, false, withCallbacks ? 1f : 0.0f, (object) null, (object[]) null);
    }

    public static int CompleteAndReturnKilledTot()
    {
      return TweenManager.FilteredOperation(OperationType.Complete, FilterType.All, (object) null, true, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int CompleteAndReturnKilledTot(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Complete, FilterType.TargetOrId, targetOrId, true, 0.0f, (object) null, (object[]) null);
    }

    public static int CompleteAndReturnKilledTotExceptFor(params object[] excludeTargetsOrIds)
    {
      return TweenManager.FilteredOperation(OperationType.Complete, FilterType.AllExceptTargetsOrIds, (object) null, true, 0.0f, (object) null, excludeTargetsOrIds);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.Flip, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int Flip(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Flip, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.Goto, FilterType.All, (object) null, andPlay, to, (object) null, (object[]) null);
    }
    ...
    public static int Goto(object targetOrId, float to, bool andPlay = false)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Goto, FilterType.TargetOrId, targetOrId, andPlay, to, (object) null, (object[]) null);
    }
    ...
    public static int KillAll(bool complete, params object[] idsOrTargetsToExclude)
    {
      if (idsOrTargetsToExclude == null)
        return (complete ? DOTween.CompleteAndReturnKilledTot() : 0) + TweenManager.DespawnAll();
      return (complete ? DOTween.CompleteAndReturnKilledTotExceptFor(idsOrTargetsToExclude) : 0) + TweenManager.FilteredOperation(OperationType.Despawn, FilterType.AllExceptTargetsOrIds, (object) null, false, 0.0f, (object) null, idsOrTargetsToExclude);
    }
    ...
    public static int Kill(object targetOrId, bool complete = false)
    {
      if (targetOrId == null)
        return 0;
      return (complete ? DOTween.CompleteAndReturnKilledTot(targetOrId) : 0) + TweenManager.FilteredOperation(OperationType.Despawn, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }

    /// <summary>Pauses all tweens and returns the number of actual tweens paused</summary>
    public static int PauseAll()
    {
      return TweenManager.FilteredOperation(OperationType.Pause, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int Pause(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Pause, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.Play, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int Play(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Play, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int Play(object target, object id)
    {
      if (target == null || id == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Play, FilterType.TargetAndId, id, false, 0.0f, target, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.PlayBackwards, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int PlayBackwards(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.PlayBackwards, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int PlayBackwards(object target, object id)
    {
      if (target == null || id == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.PlayBackwards, FilterType.TargetAndId, id, false, 0.0f, target, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.PlayForward, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int PlayForward(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.PlayForward, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int PlayForward(object target, object id)
    {
      if (target == null || id == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.PlayForward, FilterType.TargetAndId, id, false, 0.0f, target, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.Restart, FilterType.All, (object) null, includeDelay, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int Restart(object targetOrId, bool includeDelay = true, float changeDelayTo = -1f)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Restart, FilterType.TargetOrId, targetOrId, includeDelay, changeDelayTo, (object) null, (object[]) null);
    }
    ...
    public static int Restart(object target, object id, bool includeDelay = true, float changeDelayTo = -1f)
    {
      if (target == null || id == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Restart, FilterType.TargetAndId, id, includeDelay, changeDelayTo, target, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.Rewind, FilterType.All, (object) null, includeDelay, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int Rewind(object targetOrId, bool includeDelay = true)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.Rewind, FilterType.TargetOrId, targetOrId, includeDelay, 0.0f, (object) null, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.SmoothRewind, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int SmoothRewind(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.SmoothRewind, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.TogglePause, FilterType.All, (object) null, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    public static int TogglePause(object targetOrId)
    {
      if (targetOrId == null)
        return 0;
      return TweenManager.FilteredOperation(OperationType.TogglePause, FilterType.TargetOrId, targetOrId, false, 0.0f, (object) null, (object[]) null);
    }
    ...
    {
      return TweenManager.FilteredOperation(OperationType.IsTweening, FilterType.TargetOrId, targetOrId, alsoCheckIfIsPlaying, 0.0f, (object) null, (object[]) null) > 0;
    }
    ...
    private static TweenerCore<T1, T2, TPlugOptions> ApplyTo<T1, T2, TPlugOptions>(DOGetter<T1> getter, DOSetter<T1> setter, T2 endValue, float duration, ABSTweenPlugin<T1, T2, TPlugOptions> plugin = null) where TPlugOptions : struct, IPlugOptions
    {
      ...
      if (Tweener.Setup<T1, T2, TPlugOptions>(tweener, getter, setter, endValue, duration, plugin))
        return tweener;
      TweenManager.Despawn((Tween) tweener, true);
      return (TweenerCore<T1, T2, TPlugOptions>) null;
    }
  }
}
